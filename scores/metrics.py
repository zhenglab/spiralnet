...
def parse_args():
    ...
    parser.add_argument('--valrst-path', help='Path to save val result', type=str)
...
for fn in sorted(files):
    ...
    img_gt = img_resize(img_gt, img_pred.shape[1], img_pred.shape[0])
    ...
    #print("img_gt shape {} img_pred shape{} ".format(img_gt.shape, img_pred.shape))
